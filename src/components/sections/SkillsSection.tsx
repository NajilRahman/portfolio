                    ...
                    >
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono bg-[#161619] text-[#7C5CFF] border border-[#7C5CFF]/40 font-semibold">
                            {skill.level}
                          </span>
                        </div>
                      ...
                      <div className="mt-4 pt-3 border-t border-[#222227] flex justify-between items-center text-[10px] font-mono text-[#A1A1AA]">
