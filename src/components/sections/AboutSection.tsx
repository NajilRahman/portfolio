    ...
    <section id="about" className="py-24 sm:py-32 border-t border-[#222227] relative z-10">
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 text-base sm:text-lg text-[#E4E4E7] font-normal leading-relaxed">
            {profileData.bio.map((paragraph, index) => (
              <p key={index} className={index === 0 ? "text-white font-semibold text-lg sm:text-xl" : ""}>
                {paragraph}
              </p>
            ))}
            ...
            <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-mono">
              <div className="p-5 rounded-xl bg-[#121214] border border-[#222227]">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            {/* Direct Contact Card */}
            <div className="p-6 rounded-2xl bg-[#121214] border border-[#222227] flex flex-col gap-3">
              <a
