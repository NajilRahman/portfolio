...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-24 sm:py-32 border-t border-[#222227] relative z-10">
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <div className="text-sm font-mono text-[#E4E4E7] flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8 text-base sm:text-xl text-[#E4E4E7] font-normal leading-relaxed">
            ...
            <TextScrubReveal
              ...
              className="text-base sm:text-lg text-[#E4E4E7] leading-relaxed"
            />
            ...
            <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-mono">
              <div className="p-5 rounded-2xl bg-[#121214] border border-[#222227]">
                <div className="text-[#7C5CFF] font-bold mb-1.5">01. Cloud VPS Hosting</div>
                <div className="text-[#E4E4E7] text-xs leading-normal">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="p-8 rounded-3xl bg-[#121214] border border-[#222227] shadow-sm">
              ...
              <p className="text-xs text-[#E4E4E7] leading-relaxed mb-6">
                Leading senior web engineering, full-stack application development, and production Linux VPS cloud hosting infrastructure.
              </p>
              <div className="pt-4 border-t border-[#222227] flex items-center justify-between text-xs font-mono text-[#E4E4E7]">
            ...
            {/* Direct Contact Card */}
            <div className="p-6 rounded-3xl bg-[#121214] border border-[#222227] shadow-sm flex flex-col gap-3">
              <a
                href={`mailto:${profileData.email}`}
                className="flex items-center gap-3 text-sm text-[#E4E4E7] hover:text-[#7C5CFF] transition-colors"
              >
