      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {filteredProjects.map((project) => (
            <article
              key={project.id}
              className="project-card group relative rounded-2xl bg-[#121214] border border-[#222227] overflow-hidden flex flex-col justify-between transition-all duration-500 hover:border-[#7C5CFF]/60"
            >
              ...
              <div className="relative h-64 sm:h-72 w-full overflow-hidden bg-[#161619]">
                ...
                <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10">
                  <span className="px-3 py-1 rounded-full text-[11px] font-mono bg-[#0B0B0C]/80 backdrop-blur-md text-[#7C5CFF] border border-[#7C5CFF]/40 font-semibold">
        ...
        >
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-white bg-[#161619] p-4 rounded-xl border border-[#222227] leading-relaxed">
