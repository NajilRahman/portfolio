...
export const SplashCursor = ({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
      ...
      let glContext: any = canvasEl.getContext('webgl2', params);
      const isWebGL2 = !!glContext;
      if (!isWebGL2) glContext = canvasEl.getContext('webgl', params) || canvasEl.getContext('experimental-webgl', params);
